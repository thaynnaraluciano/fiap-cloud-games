    ...
    public class CriarUsuarioCommandValidator : AbstractValidator<CriarUsuarioCommand>
    {
        public CriarUsuarioCommandValidator()
        {
            RuleFor(command => command.Nome)
                ...
                .Length(3, 100).WithMessage("O nome do usuário deve ter entre 5 e 100 caracteres");

            RuleFor(command => command.Email)
                .NotEmpty().WithMessage("O e-mail do usuário é obrigatório.")
                .EmailAddress().WithMessage("Insira um e-mail válido")
                .Length(3, 100).WithMessage("O e-mail do usuário deve ter entre 5 e 100 caracteres"); ;
        }
    }
}
